 ...
 *
 */
public class LightSensorThingMQTTProxy implements LightSensorThingAPI {
	...
	public LightSensorThingMQTTProxy(String consumerId, String thingId, String host, int port) throws Exception {
