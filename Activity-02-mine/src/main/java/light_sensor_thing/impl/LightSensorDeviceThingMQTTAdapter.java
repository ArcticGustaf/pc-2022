...
public class LightSensorDeviceThingMQTTAdapter extends ThingAbstractAdapter<LightSensorDeviceThingAPI> {
	...
	public LightSensorDeviceThingMQTTAdapter(LightSensorDeviceThingAPI model, String host, int port, Vertx vertx) throws Exception {
		super(model, vertx);
		this.host = host;
		this.port = port;
	}
